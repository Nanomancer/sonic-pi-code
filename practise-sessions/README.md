...
* use pushes to log key phases after practise - log time taken in mins/secs
  ...
  * eg, git com. "session 1, part 2 - intro with drums - 2:30"

### getting up and running ASAP:

* start the basic intro on buffer 1
  * get drone loop (4 bars / 16 beats) up and running
  * get basic beep going on off-beat
* build the clock on buffer 9
  * sync to drone initially
  * then sync drone to clock
* start building up drums on buffer 0
